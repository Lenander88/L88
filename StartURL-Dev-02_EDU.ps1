...
##================================================
    ...
    $setupComplete = "Invoke-WebRequest -Uri 'https://github.com/Lenander88/L88/raw/main/SetupComplete.cmd' `
    -OutFile '$setupPath\SetupComplete.cmd'"
    # Url to Install-LCU.ps1
    $installLcu = "Invoke-WebRequest -Uri 'https://github.com/Lenander88/L88/raw/main/Install-LCU.ps1' `
...
Invoke-Expression $setupComplete

# Download Install-LCU.ps1
Invoke-Expression $installLcu
